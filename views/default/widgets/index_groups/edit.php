...
<div>
	<?php
		echo elgg_echo("theme_eersel:widgets:index_groups:which_groups");
		echo "&nbsp;" . elgg_view("input/dropdown", array(
			"name" => "params[which_groups]",
			"options_values" => $which_groups,
			"value" => $widget->which_groups,
		));
	?>
</div>
...
<div>
	<?php
		...
		echo "&nbsp" . elgg_view("input/dropdown", array(
